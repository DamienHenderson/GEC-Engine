...
void FrameBuffer::RenderStar(f32 x, f32 y, f32 z, u32 packed, f32 eye_dist)
{
	...
	u32 s_x = ((eye_dist * (x - c_x)) / (eye_dist + z)) + c_x;
	u32 s_y = ((eye_dist * (y - c_y)) / (eye_dist + z)) + c_y;
...
void FrameBuffer::RenderStar(f32 x, f32 y, f32 z, u32 packed, f32 eye_dist, u32 centre_x, u32 centre_y)
{
...
void FrameBuffer::DrawScanline(u32 y, u32 x_min, u32 x_max, u32 packed_RGBA)
{
	for (u32 i = x_min; i <= x_max; i++)
	{
